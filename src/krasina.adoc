...
:author: Jan A. Kajš
:revnumber: 0.2.0-dev.13+20201109
:doctype: book
:lang: ie
:docinfo: private
...
****
Li nómine «Occidental» del lingue international creat de Edgar de Wahl
esset 1949 viceat oficialmen per li nómine «Interlingue», sin changear li
lingue self, por evitar li politic aspecte del nómine del ancian organisation
Occidental-Union (poy Interlingue-Union).
