...
:author: Jan A. Kajš
:revnumber: 0.1.0-dev.12+20190415
:version-label: Version de edition digital:
:lang: ie
:docinfo: private
ifdef::backend-pdf[]
:doctype: book
...
Conversion a PDF:: Thomas Schimidt, 2013. Obtenibil in
http://ie-munde.com[ie-munde.com].

Conversion a Asciidoctor, revision, e edition quam libre digital:: Marcos Cruz,
2019{dot} Obtenibil in http://ne.alinome.net[ne.alinome.net] ye formates EPUB,
PDF e altris.
...
gardaforestes va esser celat. Esse sin cuida. Adio matre, dormí bon.`" E
...
quel on intra per li morte, it es per li deposition del fysic córpore. Li morte
...
// Ondra contraveni un habitu del Slavines {{{1
== Ondra contraveni un habitu del Slavines
...
ha capit li miracul. Poy il ha invitat Valdomir a scrir self su nomine. Ti
...
racontar alquó pri li psychic vive de Slavines. E Krasina, injoyat per su
interesse pri li spiritual coses, racontat que li hom es un spiritu quel vive
in un fysic córpore e simultanmen in li munde spiritual. Li córpor es limitat
...
li ver matrimonie es inpossibil sammen quam li fysic vive es inpossibil sin li
calore e luce.`"
...
"`Forsan vu ha leet alquó del sved scientist e theolog Swedenborg. Il ha
scrit pri tal coses.`"
